...
int64_t ext_euclid(int64_t a1, int64_t b1, int64_t &x1, int64_t &y1) {
  if (b1 == 0) {
    x1 = 1;
    y1 = 0;
    return a1;
  }
  int64_t res = ext_euclid(b1, a1 % b1, x1, y1);

  int64_t new_x1 = y1;
  int64_t new_y1 = (x1 - (a1 / b1) * y1);
...
void solve() {
  int64_t x1 = 0, y1 = 0;
  int64_t gcd = ext_euclid(a, b, x1, y1);
