...
int64_t n, k_x, k_y, d_x, d_y;

void solve() {
  int64_t space_to_run_x = 0;
  int64_t space_to_run_y = 0;
  ...
  if (d_y > k_y) {
    ...
    space_to_run_y = (n)-d_y;
  } else {
    space_to_run_y = 0;
  }

  int64_t ans = max(space_to_run_x, space_to_run_y);
